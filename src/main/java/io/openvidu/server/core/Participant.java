...
public class Participant {
	...
	public JsonObject toJson() {
		...
		*  Send properties for RTSP server if connection properties is null	
		*  if - else block	
		*/
		if(this.token.isConnectionPropertiesNull()) {
			propertiesJson = this.token.getServerPropertiesWithFinalJsonFormat();
		}
		else {
			propertiesJson = this.token.getConnectionPropertiesWithFinalJsonFormat();
		}
